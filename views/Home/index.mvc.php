    ...
    <div class="container flex flex-col justify-center p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
        <div class="flex flex-col justify-center p-6 text-center rounded-sm lg:max-w-md xl:max-w-lg lg:text-left">
            ...
            <div class="flex flex-col space-y-4 sm:items-center sm:justify-center sm:flex-row sm:space-y-0 sm:space-x-4 lg:justify-start">
                <a rel="noopener noreferrer" href="/reservation" class="px-8 py-3 text-lg font-semibold rounded bg-emerald-300 text-gray-900 hover:bg-emerald-400">Prendre RDV</a>
                <a rel="noopener noreferrer" href="#" class="px-8 py-3 text-lg font-semibold border rounded border-emerald-300 hover:bg-emerald-300">Me contacter</a>
            </div>
        </div>
...
<section class="sm:flex items-center max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 py-12 bg-gray-200">
    ...
    <div class="sm:w-1/2 sm:pl-12">
        <div class="text-center sm:text-left">
            <span class="text-gray-500 border-b-2 border-emerald-300 uppercase tracking-wide">Mon parcours</span>
            <h2 class="mt-4 font-bold text-3xl sm:text-4xl">À <span class="text-emerald-300">Propos</span></h2>
            <p class="mt-4 mb-6 text-lg sm:mb-10 leading-relaxed">
                Je suis psychologue diplômée, spécialisée en [spécialité]. Avec plus de 30 années d'expérience, j'accompagne les individus dans leur parcours de vie en offrant un soutien professionnel et bienveillant.
    ...
    <section class="grid w-full grid-cols-1 gap-8 px-8 py-16 mx-auto rounded-lg md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 bg-gray-100 text-gray-800">
	...
	<form novalidate="" class="space-y-6">
		...
		<div>
			...
			<input id="name" type="text" placeholder="" class="w-full p-3 rounded bg-white">
		</div>
		<div>
			<label for="email" class="text-sm">Votre Email</label>
			<input id="email" type="email" class="w-full p-3 rounded bg-white">
		</div>
		<div>
			<label for="message" class="text-sm">Votre message</label>
			<textarea id="message" rows="3" class="w-full p-3 rounded bg-white"></textarea>
		</div>
		<button type="submit" class="w-full p-3 text-sm font-bold tracki uppercase rounded bg-emerald-300 text-gray-900 hover:bg-emerald-400s">Envoyez votre message</button>
	</form>
</section>
